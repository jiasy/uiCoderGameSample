...
function c_main_hearts:init(initDict_)
    ...
    --local _instance80Dict={}
    --_specialDict["instance80"]= _instance80Dict
    --_avoidInit["instance80"]="avoidInitHere"
...
--ui structure change-------------------------------------
function c_main_hearts:uiStructureChange()
    --界面结构变化，需要做的操作。
    c_main_hearts.super.uiStructureChange(self)
end
