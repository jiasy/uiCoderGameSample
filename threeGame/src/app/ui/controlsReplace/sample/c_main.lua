--[[
    调用方式 
        1.模块名[moduleName] + 界面类名[className] 的方式
            local _targetUi=uiControl:getInstance():jumpTo("sample","main")
...
function c_main:init(initDict_)
    ...
    --local _instance6Dict={}
    --_specialDict["instance6"]= _instance6Dict
    --_avoidInit["instance6"]="avoidInitHere"
    --local _instance79Dict={}
    --_specialDict["instance79"]= _instance79Dict
    --_avoidInit["instance79"]="avoidInitHere"
