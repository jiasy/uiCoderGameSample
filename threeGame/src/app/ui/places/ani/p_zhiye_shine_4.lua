...
function p_zhiye_shine_4:initPlace(referUI_,container_)
	...
	local _maskInfos={}
	--Place all displays----------------------------------------------------------
	referUI_.instance257= cc.Sprite:create("battle_huawen_2.png")
	referUI_.instance257.name="instance257"
	mcControl:getInstance():addMcObjectToContainer(referUI_.instance257,container_,1.00,0.50,1,120,{{0,120,},{0,120,},{0,120,},{1,120,},{1,120,},{1,120,},{0,120,},{0,120,},{0,120,}},1)
