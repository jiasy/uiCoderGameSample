...
function p_tip:initPlace(referUI_,container_)
	...
	referUI_.instance3013=cc.Scale9Sprite:create("common_tip_bg_back.png", cc.rect(0,0,100.00,100.00), cc.rect(25.00,25.00,50.00,50.00))
	referUI_.instance3013.name="instance3013"
	du:placeAndAddChildToContainer(referUI_.instance3013,container_,0.00,1.00,-200,100,0,1,1,1,1)
	referUI_.instance3013:setContentSize(cc.size(400.00, 200.00))
	du:setLogicParent(referUI_.instance3013,referUI_)
	referUI_.instance3013.isSp9=true
	du:setSp9Info(referUI_.instance3013,"common_tip_bg_back.png")
