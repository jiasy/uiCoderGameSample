...
local p_move_trail_container = {}

function p_move_trail_container:initPlace(referUI_,container_)
...
function p_move_trail_container:setSpecial(referUI_)
end

return p_move_trail_container