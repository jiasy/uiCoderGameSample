...
function p_uiJumper_roll_item:initPlace(referUI_,container_)
	...
	referUI_.instance140= cc.Sprite:create("blade.png")
	referUI_.instance140.name="instance140"
	du:placeAndAddChildToContainer(referUI_.instance140,container_,0.50,0.50,40.9,-21.15,0,2.73,1.33,1,1)
	du:setLogicParent(referUI_.instance140,referUI_)
