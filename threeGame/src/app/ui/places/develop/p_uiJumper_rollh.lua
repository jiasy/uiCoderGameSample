...
local p_uiJumper_rollh = {}

function p_uiJumper_rollh:initPlace(referUI_,container_)
	...
	du:placeAndAddChildToContainer(referUI_.testBtn2,container_,0.00,0.00,123.1,-25.15,0,1,1,1,2)
    ...
    -----rect infos----------------------------------------------------------
    referUI_.rects["RectGreen"]=cc.rect(0.00,0.00,207.85,86.25)
    referUI_.rects["RectRed"]=cc.rect(0.00,0.00,164.55,45.25)
