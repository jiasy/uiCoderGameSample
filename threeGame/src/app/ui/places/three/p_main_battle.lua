...
function p_main_battle:initPlace(referUI_,container_)
	...
	du:placeAndAddChildToContainer(referUI_.fazhen,container_,0.00,0.00,0,234.05,0,1,1,1,2)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount2,container_,0.00,0.00,-79.3,412.6,0,1,1,1,3)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount3,container_,0.00,0.00,0.7,412.6,0,1,1,1,4)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount4,container_,0.00,0.00,80.7,412.6,0,1,1,1,5)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount5,container_,0.00,0.00,160.7,412.6,0,1,1,1,6)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount6,container_,0.00,0.00,-406.7,723.9,0,1,1,1,7)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount8,container_,0.00,0.00,-295.1,723.9,0,1,1,1,8)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount9,container_,0.00,0.00,-239.3,723.9,0,1,1,1,9)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount10,container_,0.00,0.00,-183.5,723.9,0,1,1,1,10)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount11,container_,0.00,0.00,274.15,403.75,0,1,1,1,11)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount7,container_,0.00,0.00,-350.9,723.9,0,1,1,1,12)
	...
	du:placeAndAddChildToContainer(referUI_.blockCount1,container_,0.00,0.00,-159.3,412.6,0,1,1,1,13)
	...
	du:placeAndAddChildToContainer(referUI_.instance166,container_,0.50,0.00,0,0,0,0.62,0.62,1,1)
