...
function p_main_battle_bar:initPlace(referUI_,container_)
	...
	referUI_.instance282= cc.Sprite:create("battle_bar_2.png")
	referUI_.instance282.name="instance282"
	mcControl:getInstance():addMcObjectToContainer(referUI_.instance282,container_,0.50,1.00,1,120,{{0,120,},{66.05,120,},{0,120,},{1,120,},{1,120,},{1,120,},{0,120,},{0,120,},{0,120,}},3)
	du:setLogicParent(referUI_.instance282,referUI_)
