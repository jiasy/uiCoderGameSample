...
function p_main_battle_blockCount:initPlace(referUI_,container_)
	...
	referUI_.instance238= cc.Sprite:create("icon_ball_special.png")
	referUI_.instance238.name="instance238"
	mcControl:getInstance():addMcObjectToContainer(referUI_.instance238,container_,0.50,0.50,1,15,{{0,15,},{0,15,},{0,15,},{0.52,1,0.6,1,0.68,1,0.76,1,0.84,1,0.92,1,1,1,1.12,1,1.22,1,1.3,1,1.38,1,1.43,1,1.47,1,1.49,1,1.5,1,},{0.52,1,0.6,1,0.68,1,0.76,1,0.84,1,0.92,1,1,1,1.12,1,1.22,1,1.3,1,1.38,1,1.43,1,1.47,1,1.49,1,1.5,1,},{0,1,0.17,1,0.33,1,0.5,1,0.67,1,0.83,1,1,1,0.84,1,0.7,1,0.57,1,0.48,1,0.4,1,0.34,1,0.31,1,0.3,1,},{0,15,},{0,15,},{0,15,}},2)
	du:setLogicParent(referUI_.instance238,referUI_)
	referUI_.instance240= cc.Sprite:create("btnUp.png")
	referUI_.instance240.name="instance240"
	mcControl:getInstance():addMcObjectToContainer(referUI_.instance240,container_,0.50,0.50,1,15,{{0,15,},{0,15,},{0,1,3.54,1,14.56,1,33.07,1,58.89,1,91.77,1,132.15,1,180,1,-132.59,1,-92.27,1,-59.44,1,-33.84,1,-15.54,1,-4.54,1,-1,1,},{1,1,0.99,1,0.97,1,0.94,1,0.9,1,0.84,1,0.77,1,0.69,1,0.77,1,0.84,1,0.9,1,0.94,1,0.97,1,0.99,1,1,1,},{1,1,1.01,1,1.04,1,1.08,1,1.15,1,1.23,1,1.33,1,1.45,1,1.33,1,1.23,1,1.15,1,1.08,1,1.04,1,1.01,1,1,1,},{1,15,},{0,15,},{0,15,},{0,15,}},3)
	du:setLogicParent(referUI_.instance240,referUI_)
